 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, QK_LEAD,  QK_LEAD,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                             KC_LALT, LOWER, KC_LGUI, KC_SPC, KC_ENT,  KC_BSPC, RAISE, KC_RGUI
),
/* LOWER
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_LOWER] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     KC_CIRC, KC_AMPR, KC_ASTR, KC_UP,    XXXXXXX,  KC_PGUP,
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_KB_VOLUME_DOWN, KC_KB_VOLUME_UP, KC_TILD, XXXXXXX, KC_LEFT, KC_DOWN,  KC_RIGHT, KC_PGDN,
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_PPLS, KC_EQL,  KC_UNDS, KC_MINS, KC_GRV,   XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [SD_LCBR] = COMBO(sd_combo, KC_LCBR),
  [XC_LPRN] = COMBO(xc_combo, KC_LPRN),
  [ER_RBRC] = COMBO(er_combo, KC_RBRC),
  [DF_RCBR] = COMBO(df_combo, KC_RCBR),
  [CV_RPRN] = COMBO(cv_combo, KC_RPRN),
